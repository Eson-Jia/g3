...
curl "http://${nacos}:8848/nacos/v1/cs/configs?group=gmssl&dataId=server_enc.crt" -o /usr/bin/server_enc.crt
curl "http://${nacos}:8848/nacos/v1/cs/configs?group=gmssl&dataId=server_enc.key" -o /usr/bin/server_enc.key
curl "http://${nacos}:8848/nacos/v1/cs/configs?group=gmssl&dataId=server_sign.crt" -o /usr/bin/server_sign.crt
curl "http://${nacos}:8848/nacos/v1/cs/configs?group=gmssl&dataId=server_sign.key" -o /usr/bin/server_sign.key
